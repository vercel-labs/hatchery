"""store: everything durable — agents, chats, and their event streams.
...
async def ensure_ready() -> None:
    ...
    from hatchery.store import agents, auth, chats, events, jobs
    from hatchery.worker import store as workers
