...
DevBox sends task events to `HATCHERY_PUBLIC_URL`. Set this to the public origin
only (for example, `https://hatchery.example`); the backend appends the
`/channels/v1/devbox` webhook path. On a laptop, run
